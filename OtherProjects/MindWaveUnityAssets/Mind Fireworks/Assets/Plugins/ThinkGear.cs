 ...
 * text manipulations:
 *   - "THINKGEAR_API" => "[DllImport ("ThinkGear")] private static extern"
 *   - "const char *"  => "string "
...
public class ThinkGear {
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_GetDriverVersion();
    ...
    public static int GetNewConnectionID(){
      handleID = TG_GetNewConnectionId();
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_SetStreamLog(int connectionId, string filename);

    public static int SetStreamLogFile(string filename){
      return TG_SetStreamLog(handleID, filename);
    }
    

    [DllImport ("ThinkGear")] 
    private static extern int TG_EnableAutoRead(int connectionId, int enabled);

    public static int EnableAutoRead(bool enabled){
      return TG_EnableAutoRead(handleID, enabled ? 1 : 0);
    }

    [DllImport ("ThinkGear")] 
    private static extern int TG_EnableBlinkDetection(int connectionId, int enabled);

    public static int EnableBlinkDetection(bool enabled){
      return TG_EnableBlinkDetection(handleID, enabled ? 1 : 0);
    }

    [DllImport ("ThinkGear")] 
    private static extern int TG_EnableZoneCalculation(int connectionId, int enabled);

    public static int EnableZoneCalculation(bool enabled){
      return TG_EnableZoneCalculation(handleID, enabled ? 1 : 0);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_SetDataLog(int connectionId, string filename);

    public static int SetDataLogFile(string filename){
      return TG_SetDataLog(handleID, filename);
    }
    ...
    public static int Connect(string serialPortName, int serialBaudRate, int serialDataFormat){
      return TG_Connect(handleID, serialPortName, serialBaudRate, serialDataFormat);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_ReadPackets(int connectionId, int numPackets);

    public static int ReadPackets(int numPackets){
      return TG_ReadPackets(handleID, numPackets);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern float TG_GetValue(int connectionId, int dataType);

    public static float GetValue(int dataType){
      return TG_GetValue(handleID, dataType);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_GetValueStatus(int connectionId, int dataType);

    public static int GetValueStatus(int dataType){
      return TG_GetValueStatus(handleID, dataType);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_SendByte(int connectionId, int b);

    public static int SendByte(int b){
      return TG_SendByte(handleID, b);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_SetBaudrate(int connectionId, int serialBaudrate);

    public static int SetBaudRate(int serialBaudRate){
      return TG_SetBaudrate(handleID, serialBaudRate);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern int TG_SetDataFormat(int connectionId, int serialDataFormat);

    public static int SetDataFormat(int serialDataFormat){
      return TG_SetDataFormat(handleID, serialDataFormat);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern void TG_Disconnect(int connectionId);

    public static void Disconnect(){
      TG_Disconnect(handleID);
    }
     ...
     */
    [DllImport ("ThinkGear")] 
    private static extern void TG_FreeConnection(int connectionId);

    public static void FreeConnection(){
      TG_FreeConnection(handleID);
